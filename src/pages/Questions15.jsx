...
function Questions15() {
  ...
  const [monthlyTaxesValue, setMonthlyTaxesValue] = useState("");
  useEffect(() => {
    const storedValue = localStorage.getItem("monthlyTaxesAmount");
    if (storedValue !== null) {
      setMonthlyTaxesValue(storedValue);
    }
  }, []);

  const handleNext = () => {
     // Convert empty or undefined value to "0"
     const valueToStore = monthlyTaxesValue !== null && monthlyTaxesValue !== 0 ? monthlyTaxesValue : "";

    localStorage.setItem("monthlyTaxesAmount", valueToStore);
    navigate("/questions17");
      ...
      <div className="w-100 d-flex justify-content-center">
        <div>
          ...
          <div className="d-flex justify-content-center flex-column align-items-center">
            <h3 className="fw-bold mt-4 mb-1">Monthly Taxes</h3>
            ...
            <div className="input-div w-100 d-flex justify-content-start border align-items-center px-3">
              ...
              <InputNumber
                ...
                placeholder="Enter amount of Monthly Taxes"
                value={monthlyTaxesValue}
                onValueChange={(e) => setMonthlyTaxesValue(e.value)}
                locale="en-us"
                minFractionDigits={2}
              />
            </div>
